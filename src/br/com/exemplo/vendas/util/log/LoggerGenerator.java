...
public final class LoggerGenerator
{
	...
	private final static Logger errorsLogger = Logger.getLogger( "portal.errors" ); // log de erros do sistema
	...
	private final static Logger responseLogger = Logger.getLogger( "portal.response" ); // log de resposta do sistema
