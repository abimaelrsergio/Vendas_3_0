...
public class ExceptionBase extends Exception 
{
	 ...
	 * 
	 * A Trace String é composta pela identificação da thread e o
	 * timestamp.
	 * 
	 ...
	 * Construtor
	 * 
	 * Assinatura de construtor que recebe a exceção original, não derivada de ExceptionBase.
	 * 
	 * Este construtor deverá ser chamada para a exception original e portanto gera a TraceString.
	 * @param e
	 */
	 ...
	 * Construtor
	 * 
	 * Assinatura de construtor que recebe uma exceção derivada de ExceptionBase e portanto
	 * já é uma exceção que encapsula a original e já possui TraceString, que é reaproveitada
	 * para que possa ser usada como elemento de trace do problema.
	 * 
	 * @param e exceção derivada de ExceptionBase
	 */
