...
public class MsgExceptionList implements Serializable
{
	 ...
	 *
	 * @param 	msgException 	informar uma coleção de MsgException a ser configurada
	 */
	 ...
	 *
	 * @param	msg 	informar uma MsgException para ser adicionada a coleção de MsgException
	 */
	 ...
	 *
	 * @param	msg 	informar uma MsgException para ser removida da coleção de MsgException
	 */
