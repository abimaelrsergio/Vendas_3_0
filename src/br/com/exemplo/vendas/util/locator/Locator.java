...
public class Locator
{
    ...
    private Object lookupLocal( String envName ) throws ServiceLocatorException
    {
        ...
        {
            throw new ServiceLocatorException("O objeto nomeado[" + envName + "] não foi encontrado localmente para JNDI service: [" + _nex.getMessage() + "].", _nex);
        }
        finally
        {
            try
            ...
            {
                logger.warn("Não foi possível fechar o contexto: [" + _nex.getMessage() + "].", _nex);
            }
        }
    }
    ...
    private Object lookupRemote( Provider provider, String envName ) throws ServiceLocatorException
    {
        ...
        {
            throw new ServiceLocatorException("O objeto nomeado[" + envName + "] não foi encontrado remotamente para JNDI service[" + provider.getProperties() + "]: [" + _nex.getMessage() + "].", _nex);
        }
        finally
        {
            try
